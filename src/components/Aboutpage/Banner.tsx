  ...
  return (
    <div>
      ...
      <section className="relative pt-[140px] md:pt-[130px] container  ">
        <div className="max-w-5xl md:max-w-7xl mx-auto px-4 sm:px-6  md:py-6 text-center">
          <motion.p
        ...
        <div className={`max-w-7xl mx-auto md:px-4 grid gap-2 lg:gap-8  transition-all duration-700 ease-in-out grid-cols-1 md:grid-cols-2 justify-between items-center`}>
          {/* Hero Image */}
          <div
            ...
            <div className="rounded-2xl overflow-hidden shadow-2xl group h-full">
              <div className="relative w-full h-full">
                ...
                <img
                  src={heroimg}
                  alt="Team collaboration"
                  className={`transition-all duration-700 ease-in-out object-cover  lg:h-[600px] h-[450px]
                     w-full`}
                />
          ...
          <div
            className={`transition-all md:px-8 duration-700 ease-in-out ${showMainText
              // ? "opacity-100 translate-x-0"
              // : "opacity-0 translate-x-10"
              }`}
          >
            <h3 className="text-[28px] lg:text-[38px] font-semibold font-poppins leading-tight">

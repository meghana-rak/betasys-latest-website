...
const BlogHero: React.FC = () => {
  return (
    ...
    <div>
      <div className="relative bg-[#022334] h-[290px] sm:h-[260px] md:h-[300px] lg:h-[380px] xl:h-[380px] overflow-hidden">
        {/* Text Content */}
         <div className="absolute z-10 px-3 transform -translate-y-1/2 top-3/4  left-2 sm:left-8 md:left-12 lg:left-32">

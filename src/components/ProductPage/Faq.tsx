          ...
          {faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <h2
                    className={`font-bold font-helvetica md:text-lg text-md transition ${isActive ? "text-black" : "text-black"
                      }`}
                  >
                    {faq.title}
                  </h2>
                ...
                >
                  <div
                    className={`px-3 py-1 mb-1 transition font-poppins font-normal md:text-sm text-xs leading-relaxed md:text-[20px]${isActive ? "bg-white text-gray-800" : "bg-gray-100 text-gray-800"
                      }`}
                  >
                    {faq.content}
                  </div>

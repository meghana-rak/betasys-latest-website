...
const OverviewSection: React.FC = () => {
  ...
  return (
     <section
      ref={setElement}
      className={` bg-[#F8F8F8]   py-10  transition-all duration-1000 ${isVisible
        ? 'opacity-100 translate-y-0'
        : 'opacity-0 translate-y-16'
        }`}
    >
    <div className="px-4 mx-auto text-justify md:py-10 max-w-7xl sm:px-6 lg:px-8">
      <div className="mb-4"> 
        <h2 className="text-2xl  font-bold text-[#000000] mb-4  my-1   md:text-3xl font-helvetica font-regular">Overview</h2>

        <p className="text-[#000000] text-sm leading-relaxed mb-4 font-poppins font-regular">
        ...
        <p className="text-[#000000] text-sm leading-relaxed  font-poppins font-regular mt-6">

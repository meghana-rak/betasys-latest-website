...
const AboutPage = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 overflow-x-hidden">
      ...
      <div
        className={`relative bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 overflow-x-hidden
          }`}
      >
        {/* Fixed Vertical Stroke removed */}
...
//           if (scrollPos < offsetTop + offsetHeight) {
//             allViewed = false;
//           }
//         }
//       });

//       setAllSectionsViewed(allViewed);
//     };
...
//   return (
//     <div className={`relative bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 overflow-x-hidden ${allSectionsViewed ? 'overflow-y-hidden' : 'overflow-y-auto'}`}>
//       {/* Fixed Vertical Stroke */}
//       {!allSectionsViewed && (
//         <div className="hidden md:block fixed z-50 top-1/2 left-5 transform -translate-y-1/2">
//           <div className="relative w-1 h-56 bg-green-200 rounded-full">
